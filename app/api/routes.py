...
def government_bidding():
    ...
    """
    # Don't query the database to prevent connection issues
    # Just render the template with sample data
    
    return render_template('government_bidding.html', active_rfps=[])
